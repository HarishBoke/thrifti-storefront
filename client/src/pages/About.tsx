          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              <div key={item.label} className="bg-[oklch(0.97_0.01_80)] rounded-sm p-6 text-center">
                <p
                  className="text-3xl font-black text-[oklch(0.52_0.22_25)] mb-1"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  {item.stat}
                </p>
                <p className="text-xs text-muted-foreground font-medium" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                  {item.label}
                </p>
              </div>
            ))}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <div key={v.title} className="text-center">
                <h3
                  className="text-4xl font-black text-[oklch(0.52_0.22_25)] mb-3"
                  style={{ fontFamily: "'Playfair Display', serif" }}
                >
                  {v.title}
                </h3>
      ...
      <div className="container py-12 sm:py-16 text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
            <Button
              className="bg-[oklch(0.52_0.22_25)] hover:bg-[oklch(0.45_0.22_25)] text-white font-semibold px-8 gap-2"
              style={{ fontFamily: "'Space Grotesk', sans-serif" }}
            >
          ...
          <Link href="/products">
            <Button
              variant="outline"
              className="border-foreground font-semibold px-8"
              style={{ fontFamily: "'Space Grotesk', sans-serif" }}
            >
              Browse Products
            </Button>
