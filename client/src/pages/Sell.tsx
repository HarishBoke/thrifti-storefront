      ...
      <section className="bg-[oklch(0.12_0.01_260)] text-white py-16 sm:py-20">
        <div className="container">
          <div className="max-w-2xl">
            <p
              className="text-[oklch(0.52_0.22_25)] text-xs font-semibold tracking-[0.3em] uppercase mb-4 font-['Space_Grotesk']"
            >
              Sell on Thrifti
            </p>
            <h1
              className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight mb-5 text-white font-['Playfair_Display']"
            >
              Your Wardrobe<br />
              Is A Transition<br />
              Fund
            ...
            >
              <Button
                className="bg-[#25D366] hover:bg-[#1ebe5d] text-white font-bold px-8 py-4 text-base gap-2 font-['Space_Grotesk']"
              >
      ...
      <section className="py-14 sm:py-20 bg-[oklch(0.97_0.01_80)]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2
              className="text-3xl sm:text-4xl font-black text-foreground font-['Playfair_Display']"
            >
              How to Sell
            </h2>
          </div>
              ...
              <div key={i} className="relative">
                <div className={`${step.color} text-white rounded-sm p-6 sm:p-8 h-full`}>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span
                      className="text-4xl font-black text-white/20 font-['Playfair_Display']"
                    >
                      {step.step}
                    </span>
                  </div>
                  <h3
                    className="text-xl font-bold mb-2 text-white tracking-wider font-['Space_Grotesk']"
                  >
                    {step.title}
                  </h3>
      ...
      <section className="py-14 sm:py-20 bg-white">
        <div className="container max-w-3xl">
          <div className="text-center mb-10">
            ...
            <h2
              className="text-3xl sm:text-4xl font-black text-foreground mb-3 font-['Playfair_Display']"
            >
          ...
          <div className="bg-[oklch(0.97_0.01_80)] rounded-sm p-6 sm:p-8 border border-border">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              <div>
                <Label className="text-xs font-semibold uppercase tracking-wider mb-1.5 block font-['Space_Grotesk']">
                  Product Name *
                </Label>
                <Input
            ...
            <Button
              ...
              className="w-full bg-[oklch(0.52_0.22_25)] hover:bg-[oklch(0.45_0.22_25)] text-white font-semibold py-3 gap-2 font-['Space_Grotesk']"
            >
            ...
            {generatedDescription && (
              <div className="mt-5 p-4 bg-white rounded-sm border border-border">
                <div className="flex items-center justify-between mb-2">
                  <p
                    className="text-xs font-semibold uppercase tracking-wider text-[oklch(0.52_0.22_25)] font-['Space_Grotesk']"
                  >
                    Generated Description
                  </p>
                  <Button
                    ...
                    size="sm"
                    onClick={handleCopy}
                    className="h-7 text-xs gap-1 font-['Space_Grotesk']"
                  >
